...
function displayCategories() {
    ...
    <div class="col-md-6 col-lg-3 my-3 myA shadow">
...
function displayMeal(meal) {
    ...
    let str = `
    <div class="col-md-4 myA text-white">
					<img class="w-100" src="${meal.strMealThumb}" alt=""
						srcset=""><br>
					<h1>${meal.strMeal}</h1>
				</div>
				<div class="col-md-8 myA text-white text-left">
					<h2>Instructions</h2>
...
$(".nav-item a").click(async (e) => {
    ...
    if (listBy == "contact") {
        ...
        row.innerHTML = `
        <section id="contact" class="container myA w-75 mx-auto mb-5 ">
		<div class="p-2">
...
$(document).scroll((e) => {
    ...
    if ($(document).scrollTop()) {
        $(".abdo").css("backgroundColor", "#0D0D0D")
    }
})
...
function userAgeValid() {
    return /^[1-9][0-9]?$|^90$/.test(userAge.value)
}
